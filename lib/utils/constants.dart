...
class AppConstants {
  ...
  static const List<int> availableDays = [0, 1, 1, 1, 1, 1, 0];
  ...
  static const TimeOfDay appt3StartTime = TimeOfDay(hour: 16, minute: 10);
  ...
  static const TimeOfDay appt3EndTime = TimeOfDay(hour: 17, minute: 30);
}
